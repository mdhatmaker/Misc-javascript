...
var $gridStyle = "div#gridForm { z-index:21; color:black; padding:2px; margin:0; font-size:11pt; font-family:Tahoma; position:fixed; right:0; top:0; " +
    ...
    "div#grid td { border:1px solid black; margin:0; padding:0; -mox-box-sizing:border-box; box-sizing:border-box; }";
...
function createGrid() {
    ...
    var lastRowStyle = "";
    if (lastcellHeight != 0) // decide the height of cells in last Row
